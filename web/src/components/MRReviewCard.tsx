...
function FileItem({ file }: { file: MRDiffFile }) {
...
export function MRReviewCard({ mrData, onApprove, onReject }: MRReviewCardProps) {
  ...
  return (
    <div className="border border-indigo-200 bg-indigo-50/50 rounded-lg mx-4 my-3 overflow-hidden">
      {/* Header */}
      ...
      {/* File list */}
      <div className="px-4 py-3 space-y-1.5 max-h-[500px] overflow-y-auto">
